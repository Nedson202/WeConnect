...
import * as businessFilter from '../middlewares/business-filterer';
...
export default (route) => {
  ...
  route.get('/api/v1/businesses', businessFilter.sortQuery, Businesses.getBusiness);
  ...
  route.delete('/api/v1/businesses/:businessId', businessFilter.filterToDelete, Businesses.deleteBusiness);
